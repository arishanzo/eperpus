...
>
  ...
  <div
              ...
              <!-- ====== Chat Card Start -->
              <div
                class="col-span-12 h-screen  rounded-sm border border-stroke bg-white py-6 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-4"
              >
                <h4
              ...
              >
                ...
                />
                    ...
                    <div class="flex flex-1 items-center justify-between">
                      <div>
                        <h5 class="font-medium">Rafael</h5>
                        <p>
                          <span class="text-sm font-medium"
                            >Kurang 20 Hari
              ...
              >
                ...
                />
                      ...
                      <span
                        class="absolute bottom-0 right-0 h-3.5 w-3.5 rounded-full border-2 border-white bg-red-500"
                      ></span>
                    </div>

                    <div class="flex flex-1 items-center justify-between">
                      <div>
                        <h5 class="font-medium">Hilman</h5>
                        <p>
                          <span class="text-sm font-medium"
                            >Terlambat
